...
var data = {headerObj : [{name : "Wohnzimmer", buttons : [{name:"Licht 1",topic:'light/licht1',type:"2"},{name:"Licht 2",topic:"light/licht2",type:"1"},{name:"Licht 3",topic:"light/licht2",type:"1"},{name:"Licht 4",topic:"light/licht2",type:"1"},{name:"Licht 5",topic:"light/licht2",type:"1"}]},{name : "Esszimmer", buttons : [{name:"Licht 3",topic:'light/licht3',type:"1"},{name:"Licht 4",topic:"light/licht4",type:"1"}]}]};
